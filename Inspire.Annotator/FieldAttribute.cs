namespace Inspire.Annotations
{
    public class FieldAttribute : EntityAttribute
    {
        ...
        public FieldAttribute(int order, int row, [CallerMemberName] string id = "", string displayName = "", bool isKey = false, int width = 6, bool autogenerated = false, ControlType controlType = ControlType.Text, string tabId = "", bool isRequired = false, string defaultValue = null, string placeholder = null) : base(id, displayName, order, isKey, width,defaultValue)
        {
            Row = row;
            Type = controlType;
