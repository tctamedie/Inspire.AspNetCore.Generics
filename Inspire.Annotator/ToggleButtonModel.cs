...
{
    public ToggleButtonModel(string CheckColumn = "IsActive", string TextWhenTrue = "Deactivate", string TextWhenFalse = "Activate", string IconWhenFalse = "fa fa-toggle-on", string IconWhenTrue = "fa fa-toggle-off", string Action = "Toggle", string Title = "Toggle", string Text = "Toggle", string Class = "btn-success")
    {
